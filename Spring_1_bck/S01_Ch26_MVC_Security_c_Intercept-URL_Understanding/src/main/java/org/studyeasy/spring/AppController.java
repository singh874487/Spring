 ...
 *  Points to remember
 *  
 *  add in file SpringSecurityConfig.xml -> <security:intercept-url pattern="/" access="permitAll" />
 *  	This will allow everyone to access the homepage without restriction. Spring will not ask for credentials to see the homepage
 *  
 *  
 *  
 */
