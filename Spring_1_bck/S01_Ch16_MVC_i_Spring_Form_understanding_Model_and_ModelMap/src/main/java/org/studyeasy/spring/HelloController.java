...
public class HelloController {	
	...
	public String helloWorld(@ModelAttribute("info") Information data, ModelMap model) {

	// we can use [Model model] instead of [ModelMap model] in the method parameter
	...
	//	model.addObject("gender",data.getGender());
		...
		model.addAttribute("fName", data.getFirstName().toUpperCase());
		model.addAttribute("lName", data.getLastName().toUpperCase());
		model.addAttribute("gender", data.getGender());
